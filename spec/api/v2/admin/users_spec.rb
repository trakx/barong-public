  ...
  describe 'Get /api/v2/admin/users/:uid' do
    ...
    context 'admin user' do
      ...
      it 'returns user info' do
        ...
        expect(json_body[:documents][0][:upload_url]).to eq experimental_user.documents[0].verification_url
        expect(json_body[:documents][0][:upload_type]).to eq experimental_user.documents[0].upload.file.extension
